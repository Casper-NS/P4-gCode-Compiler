...
public interface Analysis : Switch
{
    ...
    void CaseACstMain(ACstMain node);
    ...
    void CaseASimpleCstVariableDeclaration(ASimpleCstVariableDeclaration node);
...
public class AnalysisAdapter : Analysis
{
    ...
    public virtual void CaseACstMain(ACstMain node)
    {
        DefaultCase(node);
    }
    ...
    public virtual void CaseASimpleCstVariableDeclaration(ASimpleCstVariableDeclaration node)
    {
        DefaultCase(node);
    }
...
public class DepthFirstAdapter : AnalysisAdapter
{
    ...
    public override void CaseACstProgram(ACstProgram node)
    {
        ...
        if(node.GetCstMain() != null)
        {
            node.GetCstMain().Apply(this);
        }
        OutACstProgram(node);
    }
    public virtual void InACstMain(ACstMain node)
    {
        DefaultIn(node);
    }

    public virtual void OutACstMain(ACstMain node)
    {
        DefaultOut(node);
    }

    public override void CaseACstMain(ACstMain node)
    {
        InACstMain(node);
    ...
    public virtual void InASimpleCstVariableDeclaration(ASimpleCstVariableDeclaration node)
    {
        DefaultIn(node);
    }

    public virtual void OutASimpleCstVariableDeclaration(ASimpleCstVariableDeclaration node)
    {
        DefaultOut(node);
    }

    public override void CaseASimpleCstVariableDeclaration(ASimpleCstVariableDeclaration node)
    {
        InASimpleCstVariableDeclaration(node);
        ...
        OutASimpleCstVariableDeclaration(node);
    }
